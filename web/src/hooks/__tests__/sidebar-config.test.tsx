...
describe('security sidebar visibility', () => {
  it('old configurations show Security & Access immediately after Profile and keep API Keys', () => {
    ...
    // Security & Access sits immediately after Profile; leading entries are
    // deployment-specific modules that do not affect that adjacency.
    expect(personalItems.slice(-2)).toEqual(['Profile', 'Security & Access'])
    expect(
      result.current

...
function CardView({ card }: { card: UserGachaCard }) {
  return (
    <Card className='flex flex-col gap-3 border-border/70 bg-card/80 p-4 shadow-lg shadow-primary/5'>
